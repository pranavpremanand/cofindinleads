...
export const serviceDetails = [
  {
    ...
    thirdDescription:
      "At CoFindinLeads, we are at the forefront of integrating artificial intelligence into mobile app development, transforming the way users interact with technology. By harnessing AI, we create intuitive, personalized, and efficient mobile experiences that adapt to individual user needs. Our commitment to AI innovation ensures that your mobile applications are not only responsive but also intelligent, capable of learning and evolving to meet the dynamic demands of your audience. Partner with us to redefine the future of mobile development, delivering cutting-edge solutions that set your business apart in a competitive landscape.",
    whyMatter:
    ...
    fourthDescripiton:
      "At CoFindinLeads, we accelerate innovation through our comprehensive mobile services by integrating advanced technologies such as artificial intelligence and machine learning. This approach enables us to create intuitive, personalized, and efficient mobile experiences that adapt to individual user needs, setting your business apart in a competitive landscape.",
  },
  {
    id: 2,
    ...
    thirdHeading: "Redefine the Future with AI Innovation",
    thirdDescription:
      "Artificial Intelligence (AI) is revolutionizing UI/UX design by introducing dynamic, adaptive interfaces that respond to user behavior in real-time. This innovation enables hyper-personalization, allowing interfaces to adjust content and layout based on individual preferences, leading to more engaging user experiences.Additionally, AI enhances accessibility by tailoring interfaces to accommodate diverse user needs, ensuring inclusivity. At CoFindinLeads, we harness these advancements to craft intuitive, intelligent designs that not only meet current user expectations but also anticipate future trends, setting new standards in digital interaction.",
    whyMatter:
  ...
  },
  {
    ...
    whyMatter:
      "Why It Matters for Galactic Markets: A high-performing web presence is your digital storefront across galaxies—CoFindinLeads ensures it stands out in any dimension.",
...
`,
  ...
  },
  {
    ...
    description:
      "At CoFindinLeads, we empower businesses to streamline operations and enhance efficiency with Robotic Process Automation (RPA). By leveraging AI-driven automation, intelligent workflows, and cognitive bots, we eliminate repetitive tasks, reduce errors, and accelerate processes. Our RPA solutions enable organizations to make smarter, faster, and data-driven decisions, freeing up valuable resources to focus on innovation and strategic growth. Automate smarter, work faster, and scale effortlessly with CoFindinLeads.",
    secondHeading:
